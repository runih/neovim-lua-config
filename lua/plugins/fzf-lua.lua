return {
  ...
  keys = {
    ...
    { '<leader>flt',      '<cmd>FzfLua lsp_type_definitions<cr>',  desc = 'LSP Type Definitions', },
    { '<leader>fa',       '<cmd>FzfLua lsp_code_actions<cr>',      desc = 'LSP Code Actions', },
    { '<leader>fd',       '<cmd>FzfLua diagnostics_document<cr>',  desc = 'Diagnostics Document', },
    { '<leader>fQ',       '<cmd>FzfLua diagnostics_workspace<cr>', desc = 'Diagnostics Workspace', },
    -- Other commands
